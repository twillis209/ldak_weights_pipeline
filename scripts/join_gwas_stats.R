...
parser$add_argument('-chr_a', type = 'character', help = 'Label of chromosome column in input file A')
parser$add_argument('-chr_b', type = 'character', help = 'Label of chromosome column in input file B')
parser$add_argument('-bp_a', type = 'character', help = 'Label of BP column in input file A')
parser$add_argument('-bp_b', type = 'character', help = 'Label of BP column in input file B')
parser$add_argument('-ref_a', type = 'character', help = 'Label of reference allele column in input file A')
parser$add_argument('-ref_b', type = 'character', help = 'Label of reference allele column in input file B')
parser$add_argument('-alt_a', type = 'character', help = 'Label of alternative allele column in input file A')
