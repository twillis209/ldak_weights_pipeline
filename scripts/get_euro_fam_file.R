daf <- read.table('resources/1000g/20130606_g1k_3202_samples_ped_population.txt', header = T)
...
write.table(euro_fam, file = 'resources/1000g/euro.fam', sep = ' ', col.names = F, row.names = F, quote = F)
